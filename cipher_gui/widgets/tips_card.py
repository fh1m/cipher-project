...
class TipsCard(QFrame):
    ...
    def setup_ui(self):
        ...
        header.setStyleSheet("font-size: 14px; font-weight: 700; color: #e6edf3; margin-bottom: 6px;")
        ...
        for tip in tips:
            ...
            tip_label.setStyleSheet("color: #e6edf3; font-size: 13px; padding: 6px 0; line-height: 1.6;")
