...
class InfoCard(QFrame):
    ...
    def setup_ui(self):
        ...
        header.setStyleSheet("font-size: 14px; font-weight: 700; color: #e6edf3; margin-bottom: 8px;")
        ...
        self.info_origin.setStyleSheet("font-size: 12px; color: #7d8590; margin-bottom: 14px;")
        ...
        sec_label.setStyleSheet("font-size: 13px; color: #e6edf3; font-weight: 600; min-width: 90px;")
        security_row.addWidget(sec_label)
        
        self.info_strength = QLabel()
        self.info_strength.setStyleSheet("font-size: 15px; color: #f0883e; font-weight: 600;")
        ...
        keys_label.setStyleSheet("font-size: 13px; color: #e6edf3; font-weight: 600; min-width: 90px;")
        keys_row.addWidget(keys_label)
        
        self.info_keys = QLabel()
        self.info_keys.setStyleSheet("font-size: 13px; color: #3fb950; font-weight: 600; line-height: 1.6;")
        ...
        use_label.setStyleSheet("font-size: 13px; color: #e6edf3; font-weight: 600;")
        use_container.addWidget(use_label)
        
        self.info_use_case = QLabel()
        self.info_use_case.setStyleSheet("font-size: 13px; color: #e6edf3; line-height: 1.7;")
