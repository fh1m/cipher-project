...
class OptionsSection(QFrame):
    ...
    def setup_ui(self):
        ...
        header.setStyleSheet("font-size: 12px; font-weight: 600; color: #8b949e;")
        layout.addWidget(header)
        
        # Preserve case checkbox
        self.preserve_case_check = QCheckBox("Preserve case")
        self.preserve_case_check.setChecked(True)
        self.preserve_case_check.setStyleSheet("color: #e6edf3; font-size: 12px;")
        ...
        self.auto_history_check.setStyleSheet("color: #e6edf3; font-size: 12px;")
